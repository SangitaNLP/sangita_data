...
if sys.version_info[:2] < (3, 5):
    print(('sangita_data requires Python version 3.5 or later (%d.%d detected).' %sys.version_info[:2]))
    sys.exit(-1)
...
if __name__ == "__main__":
    setup(
        ...
        packages = ['sangita_data','sangita_data.hindi', 'sangita_data.hindi.HindiDependencyTreeBank','sangita_data.hindi.Webscraping'],
